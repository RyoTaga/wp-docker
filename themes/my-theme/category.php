...
<?php if ($my_query->have_posts()): while ($my_query->have_posts()) : $my_query->the_post(); ?>
            <div class="post">
<?php if ( $first_img = catch_that_image() ) : ?>
                <p class="thumb"><a href="<?php the_permalink(); ?>"><img src="<?php echo $first_img; ?>" width="250" alt="<?php the_title(); ?>"></a></p>
<?php endif; ?>
